...
class MY_Controller extends CI_Controller {
	...
	{
		if (!$this->session->has_userdata('userId') || !$this->session->has_userdata('desibazarAdmin')) {
	...
	public function mail($data)
	{
		...
		$this->email->from('no_reply@'.WEBSITE, SITENAME);
		$this->email->to($data['email']);

		$this->email->subject($data['subject'].' | '.SITENAME);
