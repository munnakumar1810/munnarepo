            ...
            <div class="col-left col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <section class="section-left">
                        ...
                        <form class="form-horizontal form-payment">
                           <div id="payment-new" style="display: block">
                              <div class="form-group required">
                                 <input type="text" name="payment_firstname" value=" *" placeholder="First Name" id="input-payment-firstname" class="form-control">
                              </div>
                              <div class="form-group required">
                                 <input type="text" name="payment_lastname" value="" placeholder="Last Name *" id="input-payment-lastname" class="form-control">
                              </div>
                  ...
                  <div class="checkout-content checkout-shipping-form">
                     <h2 class="secondary-title"><i class="fa fa-user"></i>Delivery Address </h2>
                     <div class="box-inner">
            ...
            <div class="col-right col-lg-6 col-md-6 col-sm-6 col-xs-12">
               ...
               <section class="section-right">
                  ...
                  <div class="checkout-content checkout-cart">
                     <h2 class="secondary-title"><i class="fa fa-shopping-cart"></i>Shopping Cart  (0.00g) </h2>
                     <div class="box-inner">
                              ...
                              <tbody>
                                 <tr>
                                    <td class="text-left name" colspan="2">
                                       <a href="http://www.webunika.com/canon-eos-5d"><img src="http://www.webunika.com/image/cache/catalog/demo/canon_eos_5d_1-80x80.jpg" alt="Canon EOS 5D" title="Canon EOS 5D" class="img-thumbnail"></a>
                                       <a href="http://www.webunika.com/canon-eos-5d" class="product-name">Canon EOS 5D</a>
                                       <br>
                                       &nbsp;
                                    ...
                                    <td class="text-left quantity">
                                       <div class="input-group">
                                          <input type="text" name="quantity[2]" value="1" size="1" class="form-control">
                                          <span class="input-group-btn">
                                             <span data-toggle="tooltip" title="" data-product-key="2" class="btn-delete" data-original-title="Remove"><i class="fa fa-trash-o"></i></span>
                                    ...
                                    <td class="text-right price">$80.00</td>
                                    <td class="text-right total">$80.00</td>
                                 </tr>
                              </tbody>
                              <tfoot>
                                 <tr>
