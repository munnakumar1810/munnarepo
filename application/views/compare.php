         ...
         <div class="table-responsive">
            <table class="table table-bordered table-hover">
               ...
               <tbody>
                  ...
                  <tr>
                     <td>Image</td>
                     <td class="text-center"><img class="img-thumbnail" title="Laptop Silver black" alt="Laptop Silver black" width="100px" src="<?= base_url()?>frontend/image/demo/shop/product/9.jpg"></td>
                     <td class="text-center"><img class="img-thumbnail" title=" Strategies for Acquiring Your Own Laptop " alt=" Strategies for Acquiring Your Own Laptop " width="100px" src="<?= base_url()?>frontend/image/demo/shop/product/10.jpg"></td>
                     <td class="text-center"><img class="img-thumbnail" title="Aspire Ultrabook Laptop" alt="Aspire Ultrabook Laptop" width="100px" src="<?= base_url()?>frontend/image/demo/shop/product/11.jpg"></td>
                  </tr>
                  <tr>
                     <td>Price</td>
