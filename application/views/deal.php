...
<div class="innerpage-ban">
  <div class="container">
    <div class="title-breadcrumb"> Today Deal's </div>
    <ul class="breadcrumb-cate">
      <li><a href="<?=base_url()?>"><i class="fa fa-home"></i></a></li>
      <li><a href="#">Today Deal's</a></li>
    </ul>
  </div>
</div>
<div class="container"><div class="row">
  <div id="content" class="col-sm-12">
    ...
    <div class="products-list row grid">
      <?php if(!empty($dealsProduct)){

        foreach ($dealsProduct as $deal) {
          ...
          <div class="right-block">
            <div class="caption">
              ...
              <div class="description item-desc hidden">
                <p><?php echo strip_tags(substr("$deal->description",0,550)); ?> </p>
              </div>
            </div>
            <div class="button-group">
              <button class="addToCart" type="button" data-toggle="tooltip"  onclick="addcart('<?= $deal->productId ?>','<?=$deal->productName?>');" data-original-title="Add to Cart"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs">Add to Cart</span></button>
              <button class="wishlist" type="button" data-toggle="tooltip" onclick="addwishlist('<?= $deal->productId ?>');" data-original-title="Add to Wish List"><i class="fa fa-heart"></i></button>
