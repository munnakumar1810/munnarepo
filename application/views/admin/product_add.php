<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<form action="<?= admin_url('products/save') ?>" method="post" enctype="multipart/form-data">
					<div class="white-box">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="productname" value="" placeholder="Product Name" id="autoGenerateUrl" class="form-control" autocomplete="off" >
									<input type="hidden" name="url" id="autoFillUrl" value="" required="">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<select class="form-control select2" name="category" id="category" required="" onchange="subCategoryListing($(this).val());" >
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" name="sku" placeholder="SKU" class="form-control" required="" autocomplete="off">
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">Price ($):</label>
									<input type="text" name="price" placeholder="46.00" required="" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label">Max. Price ($):</label>
									<input type="text" name="maxprice" placeholder="50.00" required="" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" name="rewardPoints" placeholder="For e.g. - 20" class="form-control" autocomplete="off">
								</div>
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" name="stock" placeholder="10" class="form-control" autocomplete="off" required="">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
