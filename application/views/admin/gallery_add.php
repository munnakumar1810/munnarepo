<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<form action="<?= admin_url('gallery/create') ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
					<div class="white-box">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<div class="clearfix margin-top-10 m-b-20" style="display: block;">
											...
											<span class="label label-info">Best Image Size (445 * 229 pixels)</span>
						...
						<div class="row">
							<div class="col-sm-4 col-sm-offset-4">
								<div class="form-group m-t-20">
									...
									<a class="btn btn-default waves-effect waves-light m-l-30" href="<?= admin_url('gallery/lists') ?>">
										Back
									</a>
								</div>
							</div>
