<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<form action="<?= admin_url('business/create') ?>" method="post" enctype="multipart/form-data">
					<div class="white-box">
						...
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="businessTypeName" id="businessTypeName" autocomplete="off" value="" required="">
								</div>
							</div>
						</div>
						<div class="row">
