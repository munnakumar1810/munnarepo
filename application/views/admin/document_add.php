<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<form action="<?= admin_url('document/create') ?>" method="post" enctype="multipart/form-data">
					<div class="white-box">
						...
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="documentTypeName" id="documentTypeName" autocomplete="off" value="" required="">
								</div>
							</div>
						</div>
						<div class="row">
