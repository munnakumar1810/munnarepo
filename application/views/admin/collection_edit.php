<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<form action="<?= admin_url('collection/update') ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
					<div class="white-box">
									...
									<div class="col-sm-9">
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
												<?php if (@$data->bannerImage && file_exists('./uploads/home/'.@$data->bannerImage)) { ?>
													<img src="<?= base_url('uploads/home/'.@$data->bannerImage) ?>" alt="">
												<?php } else { ?>
