	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<a href="<?= admin_url('gallery/addweekly') ?>" class="btn btn-primary m-b-20">
									...
									<tr>
										...
										<td>
											<?php if (@$v->images && file_exists('./uploads/home/'.@$v->images)) { ?>
												<img src="<?= base_url('uploads/home/'.@$v->images) ?>" alt="" style="width: 200px; max-height: 380px;">
											<?php } else { ?>
												<img src="<?= base_url('uploads/home/'.@$v->images) ?>" alt="" style="width: 200px; max-height: 380px;">
											<?php } ?>
										</td>
										...
										<td class="text-center v-a-m">
											<a href="<?= admin_url('gallery/editweekly/'.$v->id) ?>" class="btn btn-primary" data-toggle="tooltip" title="Edit">
	...
	<script>
		function deleteBanner(id) {
			swal({
				...
				if (isConfirm) {
					window.location.href = '<?= admin_url('gallery/deleteweekly/') ?>'+id
				}
			});
		}
	</script>