	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<a href="<?= admin_url('gallery/add') ?>" class="btn btn-primary m-b-20">
								...
								<?php foreach (@$list as $key => $v): ?>
									<tr>
										...
										<td class="text-center v-a-m">
											<a href="<?= admin_url('gallery/edit/'.$v->id) ?>" class="btn btn-primary" data-toggle="tooltip" title="Edit">
	...
	<script>
		function deleteBanner(id) {
			swal({
				...
				if (isConfirm) {
					window.location.href = '<?= admin_url('gallery/delete/') ?>'+id
				}
			});
		}
	</script>