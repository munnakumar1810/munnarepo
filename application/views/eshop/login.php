	...
	<section id="wrapper" class="new-login-register" style="background-image: linear-gradient(#2874f0, #7b7b7b);background-repeat: no-repeat;">
		<div class="new-login-box">
			<div class="white-box">
				...
				<form class="form-horizontal form-material" id="loginform" action="<?= seller_url('login') ?><?= ($this->input->get('redirectto'))? '?redirectto='.$this->input->get('redirectto') : ''; ?>" method="post">
