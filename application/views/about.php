         ...
         <div class="row">
            <div id="content" class="col-sm-12">
               <div class="about-us about-demo-1">
                  <div class="row">
                     <div class="col-lg-5 col-md-5 about-image"> <img src="<?= base_url()?>frontend/image/demo/about/wellcometoshop.png" alt="About Us"> </div>
                     <div class="col-lg-7 col-md-7 about-info">
                        <h2 class="about-title"><span><?=$cms->pageTitle?></span></h2>
